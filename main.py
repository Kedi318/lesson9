...
@app.route("/")
def index():
    return f'<h1>Merhaba! Bu sayfada teknoloji bağımlılığı hakkında rastgele bir bilgi öğrenebilirsin!</h1> <a href="/rastgele_gercek">Rastgele bir bilgi öğren</a> <a href="/yazitura">________</a>'
